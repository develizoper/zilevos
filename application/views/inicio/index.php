...
<a href="<?=base_url();?>login" id="login_registered" class="btn">Usuario Registrado</a>
<a href="<?=base_url();?>login/anonimous" id="login_anonymous" class="btn">Usuario Anonimo</a>
<a href="<?=base_url();?>login/fb" id="login_fb" class="btn fb">Facebook</a>
